...
# Comparison to paper: 
  # The rise in violence share during Late Bronze in the Middle East becomes slightly less pronounced due to the exclusion of Turkey, which shows an especially high violence share during this period
...
# Comparison to paper: 
# Again, overall values are only slightly affected, but the visual perception of the graph changes noticeably
# Violence share is 0% in Mesopotamia during the Chalcolithic period (n = 12), which appears inconsistent with the authors' statement that "interpersonal violence peaked during the Chalcolithic period"
# Similarly, violence share is 0% in the Levant during the Late Bronze period (n = 5), which is inconsistent with the stated increase during the Bronze Age
# However, the drop in violence share in Mesopotamia during Early Bronze (also part of the n = 12 Chalcolithic exclusion) would be consistent with the stated decline during the Early and Middle Bronze periods
