...
| **Regionms** | Isotopes | **Sig** ($p=.005$) | Borderline ($p=.051$) | **Sensitive to model** |
| **Regionl** | Isotopes | NS ($p=.165$) | **Sig** ($p=.030$) | **New Finding** |
...
**C. New Insights:**
* **Carbon Isotopes:** The model choice flips the significance of isotope proxies. In the beta-binomial model, `Regionl` (low Carbon) becomes a significant negative predictor ($p=0.030$), while the `Regionms` effect found in the Tobit model fades to borderline non-significance ($p=0.051$).
